...
export default function PainPoints() {
  return (
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden" id="conteudo">
      {/* Background accent */}
      <div className="absolute top-1/2 left-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] rounded-full bg-destructive/5 blur-[150px] -translate-y-1/2 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-8">
        ...
        <ScrollReveal className="mt-8 md:mt-12 max-w-2xl">
