    ...
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden" id="comprar">
      ...
      <div className="relative max-w-5xl mx-auto px-5 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 lg:gap-16 items-center">
          <ScrollReveal>
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground leading-[1.45] mb-4 md:mb-6"> mb-4 md:mb-6">
