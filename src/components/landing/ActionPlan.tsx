...
export default function ActionPlan() {
  return (
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute top-1/3 right-0 w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="relative max-w-4xl mx-auto px-5 md:px-8">
        <ScrollReveal className="text-center mb-10 md:mb-16">
          ...
          <h2 className="font-serif text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">
              ...
              <ScrollReveal key={i}>
                <div className={`relative flex items-start gap-6 ${
                  ...
                  <div className={`flex-1 ${i % 2 === 0 ? "md:text-right md:pr-12" : "md:text-left md:pl-12"} pl-14 md:pl-0`}>
                    <div className={`inline-block p-4 md:p-6 rounded-2xl border border-border/30 bg-gradient-to-br ${color} backdrop-blur-sm`}>
