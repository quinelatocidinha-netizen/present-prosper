      ...
      <div className="relative w-full max-w-7xl mx-auto px-5 md:px-8 py-20 md:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl">
            ...
            {/* Headline */}
            <h1
              className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-[3.4rem] font-bold className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-[3.4rem] font-bold leading-[1.3] tracking-tight text-foreground mb-5 md:mb-6 animate-fade-up" tracking-tight text-foreground mb-5 md:mb-6 animate-fade-up"
