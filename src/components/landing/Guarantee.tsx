  ...
  return (
    <section className="relative py-24 md:py-32">
      ...
      <div className="relative max-w-3xl mx-auto px-5 md:px-8">
        <ScrollReveal>
          <div className="relative p-8 md:p-12 rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/5 via-card/50 to-card/30 text-center overflow-hidden">
            {/* Corner accents */}
            ...
            <p className="font-sans text-sm md:text-base text-muted-foreground leading-relaxed max-w-lg mx-auto mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-xs font-sans text-muted-foreground">
